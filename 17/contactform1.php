    ...
    <form action="" method="post" novalidate>
        <table>
            <tr>
                <th>質問内容</th>
                <td>
                    <label><input type="radio" name="query" <?= $query == '質問' ? 'checked' : '' ?> value="質問">質問</label>
                    <label><input type="radio" name="query" <?= $query == '要望' ? 'checked' : '' ?> value="要望">要望</label>
                </td>
            </tr>
            <tr>
                <th>お名前</th>
            ...
            <tr>
                <th>お問い合わせ</th>
                <td>
                    <textarea name="detail" rows="5"><?= h($detail) ?></textarea>
